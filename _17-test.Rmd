...
\begin{align}
  ...
  1 &= 2(k - a)  (\#eq:zzz)
\end{align}
but this is clearly crazy: Equation \@ref(eq:zzz) says that $1$ is an even number! We have a blatant contradiction. 
...
***
<!-- (\#cnj:zaibatsu): $\sqrt{d}$ is an irrational number. -->
...
We now know that both $k$ and $l$ are even, and thus share $2$ as a common divisor. But this is contradictory to us having simplified the fraction $\frac{k}{l}$ as far as possible. We have found our contradiction.
