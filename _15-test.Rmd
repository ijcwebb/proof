...
<div class="alert alert-info" role="alert">
```{exercise}
Consider the following class of twelve students. Female students are coloured yellow, male students are coloured purple. The earring(s) that the students wear are indicated with black dots.
...
<div class="alert alert-info" role="alert">
```{exercise}
Take a look at the following conjecture map from Chapter 8:
...
- $P \Rightarrow Q$, "If $a^2$ is even, then $a$ is even", is **false**. <br /> Counterexample: $a^2 = 2$, $a=\sqrt{2} \neq$ an even number.
