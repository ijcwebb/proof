...
\begin{align}
    -a-b &\leq a - b
\end{align}
Adding $b$ to both sides gives $-a \leq a$ which, as $a>0$, is clearly true.
...
**Case 1:** $a=(3n)^2$ <br /> i.e. $a$ is the square of a multiple of $3$, which covers square numbers like 0, 9, 36, 81, 144, ...
...
**Case 2:** $a=(3n + 1)^2$ <br /> i.e. $a$ is the square of one more than a multiple of $3$, which covers square numbers like 1, 16, 49, 100, 169, ...
...
**Case 3:** $a=(3n + 2)^2$ <br /> i.e. $a$ is the square of two more than a multiple of $3$, which covers the remaining square numbers, like 4, 25, 64, 121, 196, ...
...
<div class="alert alert-info" role="alert">
```{exercise}
This exercise will be updated at the beginning of our next lesson.
