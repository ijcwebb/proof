...
- has an obvious base case, for example "for all positive integers" (base case = $1$), "for all three-digit primes" (base case = $01$), "for all odd numbers" (base case = $1$), etc.
...
(\#cnj:YYY): The sum of two consecutive integers is odd.
...
Conjecture \@ref(cnj:YYY):
```{proof}
First, we assume that the conjecture is true for $a$, and show that the conjecture would also be correct for the next number $a + 1$.
