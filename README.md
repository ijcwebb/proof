...
- [ ] 4. If it looks good, commit and push all changed files to GitHub. In case you cannot select files, go to Tools > Terminal then type rm .git/index.lock and retry, even if you received a warning.
