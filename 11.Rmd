...
(\#cnj:seniors): Every odd integer between 4 and 30 can be written as a sum of two primes.
  
(\#cnj:freshmen): Every composite integer between (and including) 4 and 30 can be written as a sum of two primes.
...
<!-- (\#cnj:seniors): Counterexample is 17. -->

<!-- (\#cnj:freshmen): Counterexample is 27. -->